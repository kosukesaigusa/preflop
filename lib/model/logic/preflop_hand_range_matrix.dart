...
@riverpod
class PreflopHandRangeMatricesNotifier extends _$PreflopHandRangeMatricesNotifier {
  @override
  PreflopHandRangeMatrix build() => ref.watch(availablePreflopHandRangeMatricesProvider).first;
